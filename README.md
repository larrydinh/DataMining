...
A 3 months spanned project focuses on basic and understanding of real-world data examples. The objective are to dive into the most technical machine learning algorithms to find out meaningful basec on data.
